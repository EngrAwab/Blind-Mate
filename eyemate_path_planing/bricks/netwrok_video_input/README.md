...
Your Brick **Netwrok Video Input** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/netwrok_video_input/__init__.py` and add the `@brick` decorator.
```python
# bricks/netwrok_video_input/__init__.py
...
your brick is created under the `bricks/netwrok_video_input` folder that contains the following files:
...
```yaml
id: netwrok_video_input
name: Netwrok Video Input
variables:
    - name: YOUR_NAME
